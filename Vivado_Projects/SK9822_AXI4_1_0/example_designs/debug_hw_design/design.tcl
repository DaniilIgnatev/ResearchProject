...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: SK9822_AXI4_0, and set properties
	set SK9822_AXI4_0 [ create_bd_cell -type ip -vlnv infineon.com:user:SK9822_AXI4:1.0 SK9822_AXI4_0 ]
	...
	# Connect all clock & reset of SK9822_AXI4_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins SK9822_AXI4_0/CSR]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/csr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/csr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins SK9822_AXI4_0/LEDs]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/leds_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/leds_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins SK9822_AXI4_0/R]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/r_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/r_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M03_AXI] [get_bd_intf_pins SK9822_AXI4_0/G]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/g_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/g_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M04_AXI] [get_bd_intf_pins SK9822_AXI4_0/B]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/b_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SK9822_AXI4_0/b_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to SK9822_AXI4_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/SK9822_AXI4_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SK9822_AXI4_0_B_* ]]
	puts $fp "set b_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SK9822_AXI4_0_CSR_* ]]
	puts $fp "set csr_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SK9822_AXI4_0_G_* ]]
	puts $fp "set g_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SK9822_AXI4_0_LEDs_* ]]
	puts $fp "set leds_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SK9822_AXI4_0_R_* ]]
	puts $fp "set r_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores infineon.com:user:SK9822_AXI4:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/SK9822_AXI4_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "SK9822_AXI4_v1_0_hw_${i}"
