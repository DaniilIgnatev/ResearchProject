...
(* CORE_GENERATION_INFO="top_top,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.560000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=25,HLS_SYN_LUT=254,HLS_VERSION=2023_2}" *)
...
wire   [7:0] led_byte_i_1_fu_192_p3;
reg   [7:0] led_byte_i_1_reg_216;
...
wire  signed [27:0] sext_ln15_fu_156_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        led_byte_i_1_reg_216 <= led_byte_i_1_fu_192_p3;
    end
end
...
assign icmp_ln20_fu_186_p2 = ((led_byte_id_fu_126_p1 == 2'd0) ? 1'b1 : 1'b0);

assign led_byte_i_1_fu_192_p3 = ((icmp_ln20_fu_186_p2[0:0] == 1'b1) ? 8'd229 : led_byte_i_fu_182_p1);
...
assign sext_ln15_fu_156_p1 = $signed(LED_i_fu_140_p7);

assign shl_ln_fu_164_p3 = {{led_byte_id_fu_126_p1}, {3'd0}};

assign zext_ln15_fu_160_p1 = $unsigned(sext_ln15_fu_156_p1);
